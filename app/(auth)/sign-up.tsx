    ...
    <>
      ...
      <ScrollView className="flex-1 bg-white">
        <View className="flex-1 bg-white ">
          ...
          <ReactNativeModal isVisible={varification.state === "pending"}>
            <View className="bg-white px-7 py-9 rounded-2xl min-h-[300px]">
              <Text className="text-2xl font-JakartaExtraBold mb-2">
                Varification
              </Text>
              <Text className="font-Jakarta mb-5 ">
                We send a varification code to {form.email}
              </Text>
              <InputField
                label="Code"
                icon={icons.lock}
                ...
                onChangeText={(code) =>
                  setVarification({ ...varification, code })
                }
              />
              {varification.error && (
          ...
          <ReactNativeModal isVisible={varification.state === "success"}>
            <View className=" bg-white px-7 py-9 rounded-2xl min-h-[300px]">
              <Image
                source={images.check}
              ...
              <Text className="text-base text-gray-400 font-Jakarta text-clip mt-2">
                You have successfully varified your account.
              </Text>
              <CustomButton
                title="Browse Home"
